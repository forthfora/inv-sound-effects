...
namespace InvSoundEffects
{
    ...
    public class Options : OptionInterface
    {
        ...
        public static Configurable<bool> invDeathSound = instance.config.Bind("invDeathSound", true, new ConfigurableInfo(
        ...
        public override void Initialize()
        {
            ...
            AddCheckBox(invDeathSound, (string)invDeathSound.info.Tags[0]);
            AddCheckBox(invImpactSound, (string)invImpactSound.info.Tags[0]);
